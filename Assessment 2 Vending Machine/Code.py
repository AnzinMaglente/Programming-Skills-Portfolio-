...
input("Hello, welcome to the vending machine. This program was made by Anzin R. Maglente, if you find any errors please message him. Now without further adio, let us begin. ")
