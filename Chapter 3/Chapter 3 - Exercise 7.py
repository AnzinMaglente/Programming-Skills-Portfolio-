...
print (Places)
print("\nAlphabetical order:")
print (sorted(Places)) #This sorts the places alphabetically
print("\nOriginal order:")
print (Places)
print("\nReverse Alphabetical order:")
print (sorted(Places, reverse = True)) #This sorts the places alphabetically and reversed
print("\nOriginal order:")
print (Places)
print ("\nReversed order")
Places.reverse() #This sorts the places reversed
print (Places)
print ("\nOriginal order")
Places.reverse()
print (Places)
print ("\nAlphabetical order") 
Places.sort() #This sorts the places alphabetically permanently 
print (Places)
print("\nReverse Alphabetical order:")
Places.sort(reverse = True) #This sorts the places alphabetically and reversed
print (Places)